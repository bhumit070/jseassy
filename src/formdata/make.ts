export const convertToFormData = (data: unknown) => {
    if (data) {
...
export const convertObjectToFormData = <T extends object>(data: T) => {
...
export const convertArrayToFormData = (data: Array<FormDataEntryValue>) => {
    const fd = new FormData();
